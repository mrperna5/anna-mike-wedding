...
export const stayGroups: StayGroup[] = [
...

	{
		...
		tagline: bi('Tiny, charming and full of Tuscan character.', 'Kleines, ruhiges, Bilderbuchdorf mit toskanischen Flair.'),
...

	{
		...
		tagline: bi(
			...
			'Schönste Altstadt, mitten im Herzen des Val d\'Orcia',
		),
...

	{
		...
		tagline: bi('Our little selection of Airbnb favorites', 'Unsere kleine Auswahl an Airbnb-Favoriten'),
		note: bi(
